...
class StringBinarySearchTree:
    ...
    def _sum(self, root):
        if root is None:
            return 0
        return len(root.key) + self._sum(root.left) + self._sum(root.right)
    ...
    def _is_heap(self, root):
        ...
        if root.left and len(root.left.key) > len(root.key):
            return False
        if root.right and len(root.right.key) > len(root.key):
            return False
...
string_bst.insert("orange")
string_bst.insert("banana")
string_bst.insert("grape")
string_bst.insert("kiwi")
string_bst.insert("pear")
string_bst.insert("melon")

print("Breadth Traversal:", string_bst.breadth())
...
print("Sum of Values:", string_bst.sum())
print("Average of Values:", string_bst.avg())
print("Height of Tree:", string_bst.height())
print("Cost of Most Expensive Path:", string_bst.cost_of_most_expensive_path())
print("Is AVL Tree:", string_bst.is_avl())
print("Is Heap:", string_bst.is_heap())
